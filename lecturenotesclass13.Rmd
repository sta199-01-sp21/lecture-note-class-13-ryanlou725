...
The natural point estimate to use would be the sample mean.
...
Using point estimates might not always be accurate since only one data point is used and it could vary based on the sample taken.
...
```{r data_manhattan}
manhattan <- read_csv("~/R/lecture-note-class-13-ryanlou725/manhattan.csv")
```
...
- Parameter of interest: population mean price
- Sample: Bedroom apartments in Manhattan on Craigslist
- Sample size: 20 1-bedroom apartments
...
What does this mean?
We are 95% confident that the true mean of the population lies between 2299 and 2977.
...
We are 95% confident that the population median price for 1-bedroom apartments in Manhattan lies between 2162 and 2875 dollars.
...
What does this mean?
We are 95% confident that the proportion of mice that died while not on the treatment lies between 0.690 and 0.797.
...
We are 90% confident that the proportion of mice who lived whil eon the treatment is between 0.552 and 0.651.
